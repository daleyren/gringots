...
export default function LandingPage() {
  return (
    <>
      ...
      <main className="animate-bg-gradient flex flex-col items-center justify-center min-h-screen text-zinc-100 px-4 pt-20">
      {/* Hero */}
        <div className="flex flex-row items-center justify-center min-h-[calc(100vh-100px)]">
          <section className="text-center animate-fade-up duration-1000">
            ...
            <div className="mt-8 flex gap-4 justify-center">
              ...
              <Link href="#features">
                <Button variant="secondary" size="lg" className="bg-zinc-800 text-zinc-200 hover:text-white hover:bg-zinc-900 transition">
                  See Features
                </Button>
              </Link>
            </div>
